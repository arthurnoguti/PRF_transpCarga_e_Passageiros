...
#unzip(zipfile = "acidentes2011.zip")
#unzip(zipfile = "acidentes2012.zip")
#unzip(zipfile = "acidentes2013.zip")
...
[^2]: NGUYEN, Brian. **Multivariate Statistical Analysis with R: PCA & Friends making a Hotdog**. 2020. Disponível em:  https://bookdown.org/brian_nguyen0305/Multivariate_Statistical_Analysis_with_R/what-is-pca.html. Acesso em: 21 de agosto. 2024.  
